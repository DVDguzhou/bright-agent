  ...
  return (
    <article className="mx-auto max-w-3xl pb-16">
      <header className="mb-10 border-b border-slate-200/80 pb-8">
        <p className="text-sm font-medium text-slate-500">BrightAgent</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">隐私政策</h1>
      ...
      <footer className="mt-12 rounded-2xl border border-slate-200 bg-paper/80 p-6 text-sm text-slate-600">
        <p>
          ...
          <a
            ...
            className="ml-1 text-sky-700 underline-offset-2 hover:text-sky-600 hover:underline"
        ...
        <p className="mt-4">
          <Link href="/life-agents" className="text-sky-700 hover:text-sky-600">
            返回发现页
          </Link>
        </p>
      </footer>
