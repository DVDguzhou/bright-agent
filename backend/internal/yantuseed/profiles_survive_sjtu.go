...
const surviveSjtuLongBioPrefix = `本文来自上海交通大学生存手册，著作权属原作者；以下为大学学习与生活经验分享。`

const (
	surviveSjtuAudience       = `上海交通大学或其他高校的在读学生。`
	surviveSjtuEducation      = `本科/硕士（在读）`
	surviveSjtuMajorLabel     = `大学生存指南`
	surviveSjtuKnowledgeCat   = `上交生存经验`
)

var surviveSjtuKnowledgeTags = []string{"上海交通大学", "大学生活", "学习", "保研", "考研", "出国", "选课"}

var surviveSjtuProfiles = []Profile{
	{
		DisplayName:       `阳光的柿子`,
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | CS自救指北`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：CS自救指北。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
		KnowledgeCategory: surviveSjtuKnowledgeCat,
		KnowledgeTags:     surviveSjtuKnowledgeTags,
		SampleQuestions: []string{`上交生存有什么建议？`, `怎么选课比较好？`, `大学应该怎么规划？`},
		ExpertiseTags: []string{`大学学习`, `上交`, `生存指南`, `大学生存指南`},
		KnowledgeBody: `---
...
最后，我想大学生活还是佛系一点好。有人在内卷里失去了自己最宝贵的品质；有人在追随他人的道路上奋力奔跑。不论如何，年轻永远是最宝贵的财富。人生的路很长，我也不过在[从一个坑跳到另一个坑](https://dev.bbs.sjtu.edu.cn/t/topic/853/28)。只要把这些过往都当成一份宝贵的经历，便能释然。不去追求成功，而去追求自身的成长，找到自己可以持续投入的东西，这或许是我们大学四年的长久目标。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 电院电子系信息工程专业17级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：电院电子系信息工程专业17级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
		...
		SampleQuestions: []string{`上交生存有什么建议？`, `怎么选课比较好？`, `大学应该怎么规划？`},
		ExpertiseTags: []string{`大学学习`, `上交`, `生存指南`, `大学生存指南`},
		KnowledgeBody: `# 电院电子系信息工程专业17级同学分享
...
如果是就业党，很不推荐，除非你转行去了CS，否则就业竞争力非常的低（也就只能去TpLink20W这种白菜合同了），至少得是一个研究生，议价能力强很多，虽然几年后，不知道研究生的学位含金量还有多少，但是总的来说，全都是研究生之后，没有本科生还好就业的道理。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 电院IEEE试点班介绍-1`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：电院IEEE试点班介绍-1。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
但是我们学生毕竟无力改变教育现状，能做的只能是**自救**。想学知识的人多看看国外名校公开课吧，网上有很多非常不错的资源，知乎上也有很多好课好书推荐（我也正想列一份）。想找工作的多写代码、多做项目。总之自己多上网或向前辈了解，希望往某一方向发展应该怎么做。不要等着上课等老师教、等别人来喂了（这本应是大学生的基本素质，但我觉得很多人做不到）！`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 电院计算机系13级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：电院计算机系13级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
这是一篇引领式的文章，我很想把自己思考的东西表达出来，但是苦于文字功力不够，可能很多地方想说又没说清楚。并且这几天一直在反复阅读《上海交通大学学生手册》，难免有借鉴之处，谢谢各位学长学姐的心血。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 电院信息安全16级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：电院信息安全16级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
第三，部分课程的历年考题和大作业几乎不会变化。对于考题来说，完全可以搞到往年试题（记忆版），对于大作业，也有[https://github.com/SJTU-SCS/awesome-scs](https://github.com/SJTU-SCS/awesome-scs)供参考。仅仅为了提高分数可以进行参考，但是要提升自己能力，还是得多花心思。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 会计学15级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：会计学15级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
本科的时候可以加入上海交通大学BAC协会（投行咨询协会），BAC内部结构有三条线，管理咨询条线，金融条线和协会日常运营管理，一开始可以先申请咨询和金融条线有困难的话，可以先申请加入日常运营管理条线。这里主要可以获得丰富的人脉资源，对职业规划和发展很有益处。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 机动学院机械工程专业15级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：机动学院机械工程专业15级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
		...
		SampleQuestions: []string{`上交生存有什么建议？`, `怎么选课比较好？`, `大学应该怎么规划？`},
		ExpertiseTags: []string{`大学学习`, `上交`, `生存指南`, `大学生存指南`},
		KnowledgeBody: `# 机动学院机械工程专业15级同学分享
...
进了机动学院的小朋友，如果对专业不满意，大一有转专业的机会，当然成绩不能太烂。待在本专业的，要对自己，对学院自信一点，踏踏实实学就好了，我看交大老师就对学校学生挺自信的，虽然我感觉自己本科好像啥也没学到。春招那段时间不少碰壁，逛知乎一看劝退文铺天盖地，心态很崩，找工作感觉还是挺沾学校光的，现在工作了顺多了。最后说一句，你的大学同学优秀的太多了，那些学霸学神可能竞赛全包年级前几还有一身文艺，还是要放平心态，交大已经比绝大多数学校优秀，不要感到压力太大，总会过去的。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 密西根学院15级ECE同学介绍`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：密西根学院15级ECE同学介绍。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
说了这么多，整体而言，如果是希望拿密大本科学位或者出国读研，可以来密院；如果希望打下扎实的计算机基础，或者希望在科研方面和学界大佬尽早联系，去电院和软院可能更合适哦。路都是活的，希望大家能找到相对适合自己的那条。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 人文学院同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：人文学院同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
视野不够开阔，跨理工科学习有些困难。很多事情没有流程化，办事或许存在困难等。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 软件学院介绍`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：软件学院介绍。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
由于计算机系吸引了大量考研火力，软件学院专硕考研难度不高，每年进入复试的线一般与校级工科大类复试线持平，本系同学考研本系的一半以上可以上岸，在复试中相比外校同学也有较大优势。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 数学系14级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：数学系14级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
在此特别感谢 qls 和 FrogPresident 对《交大生存手册》项目的推动，相信我们的经验一定可以给读者提供点帮助，祝愿大家都能有美好的未来。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 分！分！学生的命根！`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：分！分！学生的命根！。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
可能有很同学不相信自己做出来的东西能被授权，也可以考虑去外面的专利事务所谈谈。如果你肯花钱，也可以让他们代办。但这里要告诉读者的是：多数专利事务所接到你的委托后，大多数情况下会包给“小朋友”做（即刚刚从业的人）。申请的效果不一定比你自己申请好。当然，即使不花钱，也可以找几家专利事务所坐下来谈谈。具体思路请参考《为了留学而出国》一节中关于中介的方法。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 其他琐碎问题`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：其他琐碎问题。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
不是，2008年延安西路900号首次每年分2批次申请时（3月和6月），有很多人在3月份的第一次申请没有成功。他们又想法设法弄到的一些分数（比如前文提到的自主创业和专利），并在5月重新申请并通过。因此，笔者建议读者不要被政策中“只能申请一次”的条款限制，在三月份的第一次申请出现问题时，请想想办法找门路再在五月份申请一次。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 上海应届毕业生落户不完整指南`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：上海应届毕业生落户不完整指南。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
**TODO 2020届毕业生在新政下直接落户经验分享**`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 出国读什么学位什么专业?`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：出国读什么学位什么专业?。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
在本节的最后，我们必须要向那些为了自己的满腔兴趣和热情去读书的有志青年致敬。我们也坚信，这些人的将来，一定会有美好的前程。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 警惕出国中介`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：警惕出国中介。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
通过几轮和中介的对话，你再参考前人写的各种申请总结，就可以大致给自己一个比较准确的定位。并且，在谈判中，中介对你优缺点的分析，也有助于你在今后的申请中扬长避短，把材料准备得更出色。京沪有几家有名的中介，读者在申请时可以顺便走走看，说不定会有意外的收获。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 为了申请出国，大学期间需要准备什么`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：为了申请出国，大学期间需要准备什么。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
		...
		SampleQuestions: []string{`上交生存有什么建议？`, `怎么选课比较好？`, `大学应该怎么规划？`},
		ExpertiseTags: []string{`大学学习`, `上交`, `生存指南`, `大学生存指南`},
		KnowledgeBody: `# 为了申请出国，大学期间需要准备什么
...
当然，既然是出国念书，那么语言方面的准备自然是必不可少的了。我们不应该把对英语的学习当成一个负担。如果你真的想要做有意义的学问，那么你没有任何理由不看英文的著作和论文，没有任何理由不去了解国外的最新科研进展。而很自然地，你的英语能力会随着你在专业方面的努力而不断提高。多读英文原著，多和国外的优秀研究者交流，尽可能地让自己融入到科研的前沿，那么你的英语能力很快会有质的飞跃。当然为了能够出国，你必须得参加几项英语考试，比如 TOEFL 和 GRE 考试。不过，这些都是你到了大二可以慢慢了解和准备的，而且只要你足够的重视和一定的时间，通常都可以得到不错的分数，所以我们不建议你为了它们过分担心。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 为什么要出国?`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：为什么要出国?。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
特别需要提醒的是，现在“海归”变“海待”的情况越来越多。而国内的用人单位也越来越理智，不会因为你在海外留过学，就断定你如何出色并加以重用。如果你自己没有就读 Harvard, Yale, Princeton 那种中国老百姓耳熟能详的名校，也没有在能力上真的比国内的同龄人有长足进步，就不要指望有哪个公司会因为一张海外文凭而重用你。更有可能发生的情况是：你出国镀金，回来之后发现你的同学早就已经变成了真金白银，但是人家一看你就知道你只是表面镀金，但肚子里没东西的水货。`,
	...
	{
		DisplayName:       `洒脱的雪糕wow`,
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 辨别项目的质量`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：辨别项目的质量。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
可以的话，再多询问已经在项目组里的同学，听听他们的经历和经验，你会得到很多内幕消息。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 如何选择导师`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：如何选择导师。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
5. [https://favonia.org/advising.html](https://favonia.org/advising.html)\\(我们认为助理教授比较好的指导学生的风格\\)`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 上海交通大学CS生存指南--番外篇1`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：上海交通大学CS生存指南--番外篇1。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
要说的就是这些，写的很乱，想到什么写什么。没有去刻意批判一些交大的教育方式，因为觉得没有必要，只要能够帮助学弟学妹们做出正确的取舍就行了。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 衡量学术价值`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：衡量学术价值。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
普适好的理论要有广泛的听众。从这个意义上说，我们不应该把主要研究精力放在某个领域中某个特定子问题的某种特例上，因为哪怕有朝一日你成了这个特例问题上国际一流的专家，你的听众也不过几十个人。爱因斯坦的广义相对论之所以伟大，是因为这个理论对整个物理学界都产生了深远的影响。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 知识积累`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：知识积累。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
通过阅读综述，我们很容易找到近年来优秀文章。从这些文章开始学习，我们就可以较为全面地了解一个学科的全貌，因为无论从思维方式，解决问题的方法，还是实验设计、数据处理的细节。能被综述类文章大加赞赏的论文，一定有他独到的地方。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | ACM班小透明分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：ACM班小透明分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
说了这么多，整体而言，如果是希望拿密大本科学位或者出国读研，可以来密院；如果希望打下扎实的计算机基础，或者希望在科研方面和学界大佬尽早联系，去电院和软院可能更合适哦。路都是活的，希望大家能找到相对适合自己的那条。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 日语系 13 级学姐分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：日语系 13 级学姐分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
2. 第二句话（笑）：如果有希望询问问题、交流经验或者对日语系等文科专业如何转码等感兴趣的同学，欢迎来信：[[邮箱已隐藏]](mailto:[邮箱已隐藏])。`,
	},
	{
		DisplayName:       `安静的饼干`,
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 生物医学工程16级同学分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：生物医学工程16级同学分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
在此特别感谢 qls 和 FrogPresident 对《交大生存手册》项目的推动，相信我们的经验一定可以给读者提供点帮助，祝愿大家都能有美好的未来。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 19级测控技术与仪器转信息安全`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：19级测控技术与仪器转信息安全。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
最后的结果是大概电院内外总计60+进了13个，其中院内进了3个，院外10个。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 19级测控转软件工程`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：19级测控转软件工程。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
[http://www.jwc.sjtu.edu.cn/web/sjtu/198392-[电话已隐藏]20.htm](http://www.jwc.sjtu.edu.cn/web/sjtu/198392-[电话已隐藏]20.htm)
...
[http://bjwb.seiee.sjtu.edu.cn/bkjwb/info/16647.htm](http://bjwb.seiee.sjtu.edu.cn/bkjwb/info/16647.htm)`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 19级工科平台转软件工程分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：19级工科平台转软件工程分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
8. 后记 最后再次感谢为我提供帮助的几位非常nice的学长学姐。希望大家都能学到自己喜欢的专业。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | CS19级转入SE经验分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：CS19级转入SE经验分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
  我无法给出` + "`" + `if, else if` + "`" + `这样的结论，请各位根据我的陈述，结合自身的经验做出自己的选择。可以加我[联系方式已隐藏]，单独和我聊聊。
...
我真的希望做出的是正确的选择。最后，祝大家都能学到最适合自己的专业，也希望以后中国大学转专业能更加轻松。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 本科生转学经验分享-新加坡`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：本科生转学经验分享-新加坡。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
新加坡是一个可以考虑的转学地点，尤其对于家庭经济条件不是特别好的同学来说。这篇分享只是笔者个人的经验，不是很严谨也不保证之后的转学政策不会改变。希望大家权衡利弊，深思熟虑之后再去转学。无论成功与否，这将是你人生中很难忘的一次经历。`,
	...
	{
		DisplayName:       `活泼的烧饼wow`,
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | bi xiu lei`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：bi xiu lei。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
越是在这种糟糕的环境下，你只要稍微认真一点，你的表现也就越抢眼。另外，你还可以适当引用你上课老师过去发表过的论文作为参考文献。这种手段更是有立竿见影的加分效果！时间允许，你还可以引出一些讨论问题，然后巧妙地邀请任课老师来谈一谈，给他一个表现的机会。对于期末的测评，如果是以小论文计算分数，建议也采用上述的方法。如果是以考试检查，那么我们一定要在考试前哀求老师划重点。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | xuan xiu lei`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：xuan xiu lei。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
此外，笔者还有更加绝妙的一招。在学期结束前，你可以提交一个一两页的一个看上去很认真的论文提纲给老师阅读（一定要让这个提纲看上去很认真），并且让他提提建议！要知道，写这样一个提纲，根本不需要花费超过一个小时的时间！当然了，我们都知道，老师一般不会去仔细看你的提纲，更不会认真思考给你什么有建设意义的答复。但是，这样至少能让他记住你，以及你的论文。并在最终的评分中，因为你的认真给你一些奖励。笔者采用这个方法，大部分选修课程的分数都是在95左右。最后还要注意：最好要把东西全都打印到纸上，而不要用 email 骚扰老师。毕竟，白纸黑字比email给人一种更正式的感觉。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 软件工程15级-互联网产品经理经验分享`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：软件工程15级-互联网产品经理经验分享。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
再次强调，以上仅是一个23岁年轻人的**一家之言**，仅供参考。如果想交流一些问题，可以加我**微信fadinger**，后续还会对这篇文字进行增删改。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 你想要做什么`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：你想要做什么。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
“懂得很多道理，却依旧过不好这一生”。以后阅读这本小册子的人可能千千万，但大家毕业后的境遇会千差万别，这可能是由于同学们认知能力、运气与机遇、执行能力、家里提供的支持等等不同所导致的。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 反对 PUA`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：反对 PUA。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
6. 作者在文章结尾提到绩效评估自评时给自己打了“超出预期”的分数。请分析作者的自我评价是否合理，以及这是否与其经历中的心理变化有关？（8分）`,
	...
	{
		DisplayName:       `俏皮的饼干pro`,
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 欢迎来到上海交通大学`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：欢迎来到上海交通大学。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
而对于具体课程，教学大纲的陈旧程度也令人叹为观止。当然，以“教学经验”的名义，十年用同一本教科书是可以理解的。甚至我们可以容忍教学大纲里有一些广受诟病的古典残留物（例如《线性代数》中的 Cramer 法解方程）。但我们无法容忍对于一门只有几十年历史的新兴学科，我们的教科书竟然可以只涉及到上个世纪八十年代的“新技术”！这样的课程，之所以能够存在并延续下去，从根本上讲是因人设课——开设相应课程是为了不让部分教师下岗。这也无怪国外有华裔学者实在看不下去了，拍案疾呼道：“中国大学，怎么那么盛产‘活化石’！”。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 你的身价是多少`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：你的身价是多少。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
在交大，大多数同学家中没有许多房子也没有许多车，但他们是幸运的，至少有家庭可以负担他们在校期间的开销，不需要同学们为了筹措生活费，一边上学一边廉价地出卖自己宝贵的时间。所以，对于生计无虞的同学们，我们更应该做的不是为了蝇头小利在最底层的劳动中苦苦挣扎，而是应当积极地利用这份时间来提高我们的身价，为今后出卖高价值劳动创造机会。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 认识信息素养`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：认识信息素养。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
- 信息素养课程：如果你还不知道如何搜索指定网站的信息、如何辨别信息的真伪、如何防止位置信息在社交软件泄露，那么建议查看这些教程。
  ...
  - [上网隐私保护](https://www.bilibili.com/video/BV17p4y1Y7BB/)`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 正确地浪费剩下的时间`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：正确地浪费剩下的时间。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
我们应该对计划时间下的工作量有足够认识。小到一小时、一天，大到一个暑假、一个学期，或者是大学四年，制定切实可行的计划，并为不能完成计划自责是最基本的要求。所谓的牛人和大多数庸人的主要差别，一方面在于有没有时间可以利用；再一方面，就是时间的利用率。我们必须时刻保持一种紧迫感，以保证时间不被虚度。只要你能把在校期间的时间正确地加以利用。不需要超人的天分——甚至不需要特别努力，你都有望在你的专业领域里出类拔萃。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 做研究的兴趣`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：做研究的兴趣。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
如果去做研究，那么你从一开始就应该期望着自己能够做出影响到其他科研工作者的原创性工作。绝对不要随便跑到研究小组里给人端茶倒水，指望着通过打杂来获得一段所谓的“研究经历”，或者是一篇文章第N作者的署名权。在研究过程中，相关知识不够没关系，数学不好也没关系；但是无论如何，你需要保持一个独立思考的心态。如果有好一点的工作，可以发牛一点的文章；价值略低的工作也有名气小些的出版物可以发表。但归根结底，发表文章需要的是你的原创性思考。至于那些一年上百篇论文的高产教授和一年数十篇论文的高产学生们。我们只能很遗憾地说，他们的工作是不值一提的垃圾，这种人的存在，简直就是丢中国人的脸。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 交大转专业指南`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：交大转专业指南。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
这就是关于上海交大转专业的事情了，大家有什么想法呢，欢迎在评论区告诉小编一起讨论哦！`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 学术灌水`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：学术灌水。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
此外，笔者还有更加绝妙的一招。在学期结束前，你可以提交一个一两页的一个看上去很认真的论文提纲给老师阅读（一定要让这个提纲看上去很认真），并且让他提提建议！要知道，写这样一个提纲，根本不需要花费超过一个小时的时间！当然了，我们都知道，老师一般不会去仔细看你的提纲，更不会认真思考给你什么有建设意义的答复。但是，这样至少能让他记住你，以及你的论文。并在最终的评分中，因为你的认真给你一些奖励。笔者采用这个方法，大部分选修课程的分数都是在95左右。最后还要注意：最好要把东西全都打印到纸上，而不要用email骚扰老师。毕竟，白纸黑字比email给人一种更正式的感觉。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 三天冲刺`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：三天冲刺。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
如果你前面工作做的足够好，那你一定要有信心。题目要么你都会做，要么大家都不会做。关于选择题，请尽量用你的大脑，不要胡猜。要记住这是你和出题人 IQ 的比拼，而不是 rp 的比拼。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 广占坑，占好坑`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：广占坑，占好坑。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
最后再强调一遍，一定要记得及时换课，否则帮你占坑的同学们可就麻烦了！`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 选课选什么`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：选课选什么。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
[选课社区](https://course.sjtu.plus/)是一个不错的信息来源，在查阅的同时也希望你能分享自己对于课程的体验。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 风险与收益并存`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：风险与收益并存。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
5. 请不要忘记交每个学分100元的重修费。否则学校可能会取消课程成绩。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 理性缓考，合理重修`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：理性缓考，合理重修。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
...
关于重修课程，还有另一种方法，叫做课程替代。也就是说，你可以选择一些和你之前选的课（这门课并不一定是挂掉的，只是成绩不好就可以）的课号不同，但是内容相同或者更深入的课，然后在大四的时候申请用新修的课程替代旧课程。需要注意的是，这个重修不是自动完成的，而是需要学院盖章、教务办盖章、学校教务办审核的。这个过程手续繁琐，一般不推荐采用。但是如果你无论如何想要覆盖一门以前有过，但是后来被新的课程替代了的课，那就不得不采取这个方法了。一般情况，合理的替代课程会被通过。但是其它的情况，需要你跟你们学院教务老师好好解释，搞好关系，才可能做到。`,
	},
	{
		...
		School:            `上海交通大学`,
		MajorLine:         `大学生存指南`,
		ArticleTitle:      `上交生存 | 伟大的选修课`,
		LongBioPrefix:     surviveSjtuLongBioPrefix,
		ShortBio:          `来自上海交通大学生存手册：伟大的选修课。`,
		Audience:          surviveSjtuAudience,
		WelcomeMessage:    `你好，欢迎问我关于上海交通大学学习和生活的问题。`,
		Education:         surviveSjtuEducation,
		MajorLabel:        surviveSjtuMajorLabel,
