...
var csslProfiles2 = []Profile{
	{
		DisplayName:       `安静的煎饼小号`,
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | CS224w: Machine Learning with Graphs`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS224w: Machine Learning with 。`,
		...
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS224w: Machine Learning with Graphs
...
- Assignments: <http://web.stanford.edu/class/cs224w/>,  with 6 programming assignments, 3 LaTeX written assignments`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | Coursera: Deep Learning`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Coursera: Deep Learning。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Coursera: Deep Learning
...
- Assignments: <https://www.coursera.org/specializations/deep-learning>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | CS231n: CNN for Visual Recognition`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS231n: CNN for Visual Recogni。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS231n: CNN for Visual Recognition
...
- Coursework：<http://cs231n.stanford.edu/schedule.html>，3 Programming Assignments`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | CS285: Deep Reinforcement Learning`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS285: Deep Reinforcement Lear。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS285: Deep Reinforcement Learning
...
- 课程作业：<http://rail.eecs.berkeley.edu/deeprlcourse/>，5个编程作业`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | UMich EECS 498-007 / 598-005: Deep Learning for Co`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：UMich EECS 498-007 / 598-005: 。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UMich EECS 498-007 / 598-005: Deep Learning for Computer Vision
...
@Michael-Jetson 本人所做的二三十万字的笔记（并没有包括作业等），可以当做一个参考[Michael-Jetson/ML_DL_CV_with_pytorch](https://github.com/Michael-Jetson/ML_DL_CV_with_pytorch)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | National Taiwan University: Machine Learning by Hu`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：National Taiwan University: Ma。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# National Taiwan University: Machine Learning by Hung-yi Lee
...
- Course Assignments：[Spring2023](https://speech.ee.ntu.edu.tw/~hylee/ml/2023-spring.php)(15 labs covering a wide range of deep learning domains), [Spring2025](https://speech.ee.ntu.edu.tw/~hylee/ml/2025-spring.php) (focus on  LLM related work like AI Agent)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | 国立台湾大学：李宏毅机器学习`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：国立台湾大学：李宏毅机器学习。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 课程作业：[Spring2023](https://speech.ee.ntu.edu.tw/~hylee/ml/2023-spring.php) (5 个 lab，几乎覆盖了主流深度学习的所有领域；部分作业colab上可能无法打开，这时候可以参考弘毅老师的github), [Spring2025](https://speech.ee.ntu.edu.tw/~hylee/ml/2025-spring.php) (主要关注 AI Agent 等 LLM 相关领域)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | MIT 6.7960: Deep Learning`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT 6.7960: Deep Learning。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT 6.7960: Deep Learning
...
No public personal repository is currently provided for this course.`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度学习`,
		ArticleTitle:      `CS自学 | NYU DLSP21: NYU Deep Learning Spring 2021`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：NYU DLSP21: NYU Deep Learning 。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度学习`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# NYU DLSP21: NYU Deep Learning Spring 2021
...
No public personal repository is currently provided for this course.`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | MIT6.S184: Generative AI with Stochastic Different`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT6.S184: Generative AI with 。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT6.S184: Generative AI with Stochastic Differential Equations
...
- 课程作业：三个实验，具体参见课程网站`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | Deep Generative Models Roadmap`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Deep Generative Models Roadmap。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Deep Generative Models Roadmap
...
- [MLsys-Guide](https://github.com/PKU-DAIR/Starter-Guide/blob/main/docs/systems/Readme.md): A beginner’s guide to deep learning systems.`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | 深度生成模型学习路线`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：深度生成模型学习路线。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- [MLsys-Guide](https://github.com/PKU-DAIR/Starter-Guide/blob/main/docs/systems/Readme.md): 深度学习系统入门指南`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | CMU11-667: Large Language Models: Methods and Appl`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU11-667: Large Language Mode。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU11-667: Large Language Models: Methods and Applications
...
- 课程作业：共六次作业，涵盖预训练数据准备、Transformer 实现、检索增强生成、模型比较与偏见缓解、训练效率提升等主题，详情见 <https://cmu-llms.org/assignments/>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | CMU 11-711: Advanced Natural Language Processing (`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU 11-711: Advanced Natural L。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU 11-711: Advanced Natural Language Processing (ANLP)
...
* 课程作业：[https://www.phontron.com/class/anlp-fall2024/assignments/](https://www.phontron.com/class/anlp-fall2024/assignments/)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | CMU 11-868: Large Language Model Systems`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU 11-868: Large Language Mod。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU 11-868: Large Language Model Systems
...
- 课程教材：精选论文 + 《Programming Massively Parallel Processors, 4th Ed》 部分章节`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `深度生成模型`,
		ArticleTitle:      `CS自学 | CMU 15-779: Advanced Topics in Machine Learning Sy`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU 15-779: Advanced Topics in。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `深度生成模型`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU 15-779: Advanced Topics in Machine Learning Systems (LLM Edition)
...
- 预备材料（深度学习入门材料汇总）：<https://www.cs.cmu.edu/~zhihaoj2/15-779/materials.html>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `电子基础`,
		ArticleTitle:      `CS自学 | UCB EE16A&B: Designing Information Devices and Sys`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：UCB EE16A&B: Designing Informa。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `电子基础`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UCB EE16A&B: Designing Information Devices and Systems I&II
...
All the resources and assignments used by @PKUFlyingPig in this course are maintained in [PKUFlyingPig/EE16A - GitHub](https://github.com/PKUFlyingPig/EE16A).`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `电子基础`,
		ArticleTitle:      `CS自学 | MIT 6.007 Signals and Systems`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT 6.007 Signals and Systems。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `电子基础`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT 6.007 Signals and Systems
...
- Assignments: <https://ocw.mit.edu/resources/res-6-007-signals-and-systems-spring-2011/assignments>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `电子基础`,
		ArticleTitle:      `CS自学 | UCB EE120: Signal and Systems`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：UCB EE120: Signal and Systems。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `电子基础`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UCB EE120: Signal and Systems
...
All the resources and assignments used by @PKUFlyingPig in this course are maintained in [PKUFlyingPig/UCB-EE120 - GitHub](https://github.com/PKUFlyingPig/UCB-EE120)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | UCB CS161: Computer Security`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：UCB CS161: Computer Security。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `系统安全`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UCB CS161: Computer Security
...
@PKUFlyingPig 在学习这门课中用到的所有资源和作业实现都汇总在 [PKUFlyingPig/UCB-CS161 - GitHub](https://github.com/PKUFlyingPig/UCB-CS161) 中。`,
	...
	{
		DisplayName:       `勤劳的奶茶pro`,
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | ASU CSE365: Introduction to Cybersecurity`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：ASU CSE365: Introduction to Cy。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `系统安全`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# ASU CSE365: Introduction to Cybersecurity
...
- Chat on Discord: <https://discord.com/channels/750635557666816031/[电话已隐藏]28913058>
- Open Source on GitHub: <https://github.com/pwncollege>
- Contact us via Email: <[邮箱已隐藏]>
...
另外，出于评定 ASU 学生课程成绩的重要因素，官方不鼓励上传解题思路，每个模块的前两题除外。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | ASU CSE466: Computer Systems Security`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：ASU CSE466: Computer Systems S。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `系统安全`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# ASU CSE466: Computer Systems Security
...
另外，出于评定 ASU 学生课程成绩的重要因素，官方不鼓励上传解题思路，每个模块的前两题与逆向部分的 16 题除外。`,
	...
	{
		DisplayName:       `机灵的马卡龙cc`,
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | MIT6.1600: Foundations of Computer Security`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT6.1600: Foundations of Comp。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `系统安全`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT6.1600: Foundations of Computer Security
...
@PKUFlyingPig 在学习这门课中用到的所有资源和作业实现都汇总在 [PKUFlyingPig/MIT6.1600 - GitHub](https://github.com/PKUFlyingPig/MIT6.1600) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | MIT 6.858: Computer System Security`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT 6.858: Computer System Sec。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `系统安全`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT 6.858: Computer System Security
...
- 课程作业：4 个 Lab + Final Project / Lab5`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `系统安全`,
		ArticleTitle:      `CS自学 | SEEDLabs`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：SEEDLabs。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
@LaPhilosophie 在学习这门课中用到的所有资源和作业实现都汇总在  [LaPhilosophie/seedlab - GitHub](https://github.com/LaPhilosophie/seedlab) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | UCB: Sysadmin DeCal`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：UCB: Sysadmin DeCal。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UCB: Sysadmin DeCal
...
- 课程作业：见课程官网`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | MIT: The Missing Semester of Your CS Education`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT: The Missing Semester of Y。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT: The Missing Semester of Your CS Education
...
- Assignments: Some exercises after each lecture, refer to the course website.`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | MIT-Missing-Semester`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT-Missing-Semester。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT-Missing-Semester
...
- 课程作业：一些随堂小练习，具体见课程网站。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS50: This is CS50x`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS50: This is CS50x。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS50: This is CS50x
...
@figuretu 将有价值的提问讨论以及相关学习资源整理在共享文档 [CS50 - 资源总目录](https://uufyjevghz.feishu.cn/docx/DP78d2U5TosTOTx9QCbcjp8GnBh) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | Introductory C Programming Specialization`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Introductory C Programming Spe。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Introductory C Programming Specialization
...
@haidongji 在学习这门课中的作业实现都汇总在 [Duke Coursera Intro C](https://code.haidongji.com/Duke_Coursera_Intro_C/) 中。因为时间关系，我最后一课最后一周的几个作业到目前还没有完成。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | Amirkabir University of Technology 1400-2: Advance`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Amirkabir University of Techno。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Amirkabir University of Technology 1400-2: Advanced Programming Course
...
- 课程作业：7 homework`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | Stanford CS106B/X: Programming Abstractions in C++`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Stanford CS106B/X: Programming。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Stanford CS106B/X: Programming Abstractions in C++
...
课程视频我推荐 [youtube spring 2015](https://www.youtube.com/watch?v=FIroM06V2MA&list=PL-h0BZdG_K4kAmsfvAik-Za826pNbQd0d) 这个版本，授课激情，并且可以看到老师和学生之间在提问环节的精彩交互（几百名优秀 compiler 的观察总会提出一些有趣的问题）`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS106L: Stanford C++ Programming`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS106L: Stanford C++ Programmi。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS106L: Stanford C++ Programming
...
All the resources and assignments used by @PKUFlyingPig are maintained in [PKUFlyingPig/CS106L - GitHub](https://github.com/PKUFlyingPig/CS106L).`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS106L: Standard C++ Programming`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS106L: Standard C++ Programmi。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS106L: Standard C++ Programming
...
@PKUFlyingPig 在学习这门课中用到的所有资源和作业实现都汇总在 [PKUFlyingPig/CS106L - GitHub](https://github.com/PKUFlyingPig/CS106L) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS3110：OCaml Programming Correct + Efficient + Bea`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS3110：OCaml Programming Corre。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS3110：OCaml Programming Correct + Efficient + Beautiful
...
@featherwit001 在学习这门课中用到的所有资源和作业实现都汇总在 [featherwit001/CS3110_OCaml_Programming - GitHub](https://github.com/featherwit001/CS3110_OCaml_Programming) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | Haskell MOOC`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Haskell MOOC。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
@showtheunli 在学习这门课中用到的所有资源和作业实现都汇总在 [showthesunli/haskell-mooc - GitHub](https://github.com/showthesunli/haskell-mooc) 中。(非常不建议在作业时，参考别人的实现)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | MIT 6.092: Introduction To Programming In Java`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT 6.092: Introduction To Pro。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT 6.092: Introduction To Programming In Java
...
@Harbour-z 在学习这门课中用到的所有资源和作业实现都汇总在 [Harbour-z/MIT6.092 - Github](https://github.com/Harbour-z/Course_learning/tree/main/MIT6.092) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS50P Introduction to Programming with Python`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS50P Introduction to Programm。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS50P Introduction to Programming with Python
...
All the resources and assignments used by @mancuoj in this course are maintained in [mancuoj/CS50P - GitHub](https://github.com/mancuoj/CS50P).`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS61A: Structure and Interpretation of Computer Pr`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS61A: Structure and Interpret。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS61A: Structure and Interpretation of Computer Programs
...
@InsideEmpire 在学习这门课中用到的所有资源和作业实现都汇总在 [InsideEmpire/CS61A - GitHub](https://github.com/InsideEmpire/CS61A-PathwayToSuccess/)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | MIT6.100L: Introduction to CS and Programming usin`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT6.100L: Introduction to CS 。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT6.100L: Introduction to CS and Programming using Python
...
@Alidme 在学习这门课时，总结了关于此课程的相关文档 [MIT6.100L 食用指南(持续更新)](https://k14eszn58mj.feishu.cn/docx/NFxmd1JxPodkWjxeuHIcSK5Qnag)。此外，其在学习这门课的 Problem Sets 的实现都汇总在 [Alidme/MIT6.100L - GitHub](https://github.com/Alidme/MIT6.100L) 中。`,
	...
	{
		DisplayName:       `慵懒的鲸鱼lab`,
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS110L: Safety in Systems Programming`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS110L: Safety in Systems Prog。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS110L: Safety in Systems Programming
...
在2022年 CS110L 没有开源作业源码的背景下，Rust 快速演进导致2020版本课程项目中所使用的库过于老旧。对此，[@fung-hwang](https://github.com/fung-hwang) 尝试进行了适配（时间为2022.11)。其适配过程和作业实现都汇总在 [fung-hwang/CS110L-2020spr - GitHub](https://github.com/fung-hwang/CS110L-2020spr) 中。也许当你开始本课程时 Rust 和这些库又发生了变化，但你仍可以参考并从中获得启发。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS220: Programming Principles`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS220: Programming Principles。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS220: Programming Principles
...
互联网上并没有公开的参考答案，也并不确定本课程主讲人是否赞同这种公开答案的行为。如果遇到困难，课程的 [ISSUE](https://github.com/kaist-cp/cs220/issues) 之中可以找到关于作业的讨论。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程入门`,
		ArticleTitle:      `CS自学 | CS431: Concurrent Programming`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS431: Concurrent Programming。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程入门`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS431: Concurrent Programming
...
- 课程作业：[Homework](https://github.com/kaist-cp/cs431/tree/main/homework)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | CS242 Programming Languages`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS242 Programming Languages。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程语言设计与分析`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS242 Programming Languages
...
- 课程作业：[实验指导](https://stanford-cs242.github.io/f19/assignments/)与[作业仓库](https://github.com/stanford-cs242/f19-assignments)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | Cambridge: Semantics of Programming Languages`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Cambridge: Semantics of Progra。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程语言设计与分析`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Cambridge: Semantics of Programming Languages
...
- 课程作业：考试真题中的相关题目汇总在 [这里](https://www.cl.cam.ac.uk/teaching/exams/pastpapers/t-SemanticsofProgrammingLanguages.html)，但是相关作业题 (Cambridge 内部的 supervision) 以及所有题目的答案均不公开。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | NJU Software Analysis`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：NJU Software Analysis。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程语言设计与分析`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# NJU Software Analysis
...
- OJ: [OJ](https://oj.pascal-lab.net/problem)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | NJU 软件分析`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：NJU 软件分析。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 在线评测： [OJ](https://oj.pascal-lab.net/problem)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | PKU Software Analysis`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：PKU Software Analysis。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编程语言设计与分析`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# PKU Software Analysis
...
- Course Textbook: None`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编程语言设计与分析`,
		ArticleTitle:      `CS自学 | 北京大学 软件分析技术`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：北京大学 软件分析技术。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 课程教材：无`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | Stanford CS143: Compilers`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Stanford CS143: Compilers。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编译原理`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Stanford CS143: Compilers
...
@skyzluo 在学习这门课中用到的所有资源和作业实现都汇总在 [skyzluo/CS143-Compilers-Stanford - GitHub](https://github.com/skyzluo/CS143-Compilers-Stanford) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | CS420: Compiler Design`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS420: Compiler Design。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编译原理`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS420: Compiler Design
...
- 课程作业：<https://github.com/kaist-cp/cs420?tab=readme-ov-file#homework-60>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | NJU Compilers`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：NJU Compilers。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- Assignments: 10 written assignments + 8~10 programming labs`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | NJU 编译原理`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：NJU 编译原理。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 课程作业：10 个书面作业 + 8 ~ 10 个编程作业带你实现一个编译器`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | PKU Compiler Principles Practice`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：PKU Compiler Principles Practi。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编译原理`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# PKU Compiler Principles Practice
...
Finally, my highest regards to @MaxXing. — from PKUFlyingPig`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | PKU 编译原理实践`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：PKU 编译原理实践。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
最后，向 @MaxXing 致以我崇高的敬意。—— from PKUFlyingPig`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | SJTU Compiler Principles`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：SJTU Compiler Principles。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编译原理`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# SJTU Compiler Principles
...
- 2 Quizzes + 5 essential labs + 2 optional labs
	...
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | SJTU 编译原理`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：SJTU 编译原理。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 2 次 Quiz + 5 个必做 Lab + 2 个选做 Lab
	...
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `编译原理`,
		ArticleTitle:      `CS自学 | USTC: Principles and Techniques of Compiler`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：USTC: Principles and Technique。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `编译原理`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# USTC: Principles and Techniques of Compiler
...
- 课程作业：<https://ustc-compiler-principles.github.io/textbook>`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | CMU 15-462 : COMPUTER GRAPHICS`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU 15-462 : COMPUTER GRAPHICS。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机图形学`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU 15-462 : COMPUTER GRAPHICS
...
- 课程作业：参见课程主页`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | Stanford CS148`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Stanford CS148。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 课程作业：[8 个 hw, 1 个 final project](https://web.stanford.edu/class/cs148/assignments.html)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | GAMES101`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：GAMES101。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
@ysj1173886760 在学习这门课中用到的所有资源和作业实现都汇总在[ysj1173886760/Learning: graphics/GAMES101 - GitHub](https://github.com/ysj1173886760/Learning/tree/master/graphics/GAMES101) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | GAMES103`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：GAMES103。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
@indevn 在学习这门课中用到的所有资源和作业要求都汇总在 [GAMES103 Unoffical](https://github.com/indevn/GAMES103) 中。对于作业的具体实现，在知乎上有很多相关文章进行了细致讲解可以参考。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | GAMES202`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：GAMES202。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
- 课程作业：[5个project](http://games-cn.org/forums/topic/games202zuoyehuizong/)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机图形学`,
		ArticleTitle:      `CS自学 | USTC Computer Graphics`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：USTC Computer Graphics。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机图形学`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# USTC Computer Graphics
...
- 课程作业：http://staff.ustc.edu.cn/~lgliu/Courses/ComputerGraphics_2020_spring-summer/default.htm ，九个作业加一个 Project ，具体看官网`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机系统基础`,
		ArticleTitle:      `CS自学 | CS110: Principles of Computer Systems`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS110: Principles of Computer 。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机系统基础`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS110: Principles of Computer Systems
...
@xuzheng465 在学习这门课中用到的所有资源和作业实现都汇总在 [xuzheng465/Stanford_CS110 - GitHub](https://github.com/xuzheng465/Stanford_CS110) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机系统基础`,
		ArticleTitle:      `CS自学 | CMU CS15213: CSAPP`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU CS15213: CSAPP。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机系统基础`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU CS15213: CSAPP
...
- [Proxy Lab](https://arthals.ink/posts/experience/proxy-lab)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机网络`,
		ArticleTitle:      `CS自学 | CS144: Computer Network`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS144: Computer Network。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机网络`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS144: Computer Network
...
- [Joey](http://yuzijun.life/2021-02/CS144)`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机网络`,
		ArticleTitle:      `CS自学 | CS 168: Introduction to the Internet: Architecture`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS 168: Introduction to the In。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机网络`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CS 168: Introduction to the Internet: Architecture and Protocols
...
All the resources and assignments used by @XXX in this course are maintained in [PKUFlyingPig/UCB-CS168 - GitHub](https://github.com/PKUFlyingPig/UCB-CS168).`,
	},
	{
		...
		ArticleTitle:      `CS自学 | CS 168：Introduction to the Internet: Architecture `,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CS 168：Introduction to the Int。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
...
@PKUFlyingPig 在学习这门课中用到的所有资源和作业实现都汇总在 [PKUFlyingPig/UCB-CS168 - GitHub](https://github.com/PKUFlyingPig/UCB-CS168) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机网络`,
		ArticleTitle:      `CS自学 | Computer Networking: A Top-Down Approach`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：Computer Networking: A Top-Dow。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机网络`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# Computer Networking: A Top-Down Approach
...
@PKUFlyingPig 在学习这门课中用到的所有资源和作业实现都汇总在 [PKUFlyingPig/Computer-Network-A-Top-Down-Approach - GitHub](https://github.com/PKUFlyingPig/Computer-Network-A-Top-Down-Approach) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `计算机网络`,
		ArticleTitle:      `CS自学 | USTC Computer Networking:A Top-Down Approach`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：USTC Computer Networking:A Top。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `计算机网络`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# USTC Computer Networking:A Top-Down Approach
...
- Textbook: _Computer Networking: A Top-Down Approach, 7th Edition_`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `软件工程`,
		ArticleTitle:      `CS自学 | CMU 17-803: Empirical Methods`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：CMU 17-803: Empirical Methods。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		KnowledgeTags:     csslKnowledgeTags,
		SampleQuestions: []string{`计算机自学怎么入门？`, `有哪些好的CS公开课？`, `怎么系统学习计算机？`, `AI方向学什么课？`},
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `软件工程`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# CMU 17-803: Empirical Methods
...
这门课中用到的所有资源都汇总在 [bvasiles/empirical-methods - GitHub](https://github.com/bvasiles/empirical-methods) 中。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `软件工程`,
		ArticleTitle:      `CS自学 | MIT 6.031: Software Construction`,
		LongBioPrefix:     csslLongBioPrefix,
		ShortBio:          `来自北大CS自学指南的课程推荐与学习经验：MIT 6.031: Software Constructi。`,
		Audience:          csslAudience,
		WelcomeMessage:    `你好，欢迎问我关于计算机自学路线和课程推荐的问题。`,
		Education:         csslEducation,
		MajorLabel:        csslMajorLabel,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `软件工程`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# MIT 6.031: Software Construction
...
@pengzhangzhi 完成了这门课的作业并记录了笔记, 代码开源在 [pengzhangzhi/self-taught-CS/Software Construction - Github](https://github.com/pengzhangzhi/self-taught-CS/tree/main/Software%20Construction)。`,
	},
	{
		...
		School:            `CS自学指南`,
		MajorLine:         `软件工程`,
		ArticleTitle:      `CS自学 | UCB CS169: software engineering`,
		LongBioPrefix:     csslLongBioPrefix,
		...
		ExpertiseTags: []string{`计算机自学`, `课程推荐`, `编程学习`, `软件工程`},
		Source: `北大CS自学指南`,
		KnowledgeBody: `# UCB CS169: software engineering
