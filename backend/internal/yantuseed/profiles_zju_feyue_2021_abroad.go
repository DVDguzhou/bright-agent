...
var maoYuHao = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 毛宇豪 CS MSc @ ETH Zurich（境外升学）",
...
var zhouKaiWen = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 周凯文 CS Ph.D. @ UCSC（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var liXiangTian = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 李翔天 MLDS @ UCSD（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var xuJing = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 许璟 MSDS @ Harvard（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var chenLongTeng = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 陈龙腾 @ École Polytechnique（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var xiaRuiZhe = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 夏睿哲 Applied Math Ph.D. @ HKUST（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
