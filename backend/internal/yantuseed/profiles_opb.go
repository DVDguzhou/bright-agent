...
const opbLongBioPrefix = `本文来自《一人企业方法论》v2（easychen），著作权属原作者；以下为一人企业/独立创业方法论，仅供参考。`

const (
	opbAudience       = `想做副业、独立开发、自媒体或一人企业的程序员和创业者。`
	opbEducation      = `自学/本科/硕士（在职或自由职业）`
	opbMajorLabel     = `创业方向`
	opbKnowledgeCat   = `创业方法论`
)

var opbKnowledgeTags = []string{"一人企业", "独立开发", "副业", "创业", "被动收入", "SaaS", "个人品牌", "自媒体"}

var opbProfiles = []Profile{
	{
		DisplayName:       `节点86`,
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 资产与被动收入`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `资产与被动收入：如何构建可持续的收入来源。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
		KnowledgeCategory: opbKnowledgeCat,
		KnowledgeTags:     opbKnowledgeTags,
		SampleQuestions: []string{`一人企业怎么起步？`, `如何找到适合的副业方向？`, `独立开发怎么变现？`, `如何构建被动收入？`},
		ExpertiseTags: []string{`独立创业`, `一人企业`, `一人企业`},
		OriginalAuthor: `easychen`,
		Source: `一人企业方法论`,
		KnowledgeBody: `# 底层逻辑:资产和被动收入
...
从以上五个方面对一个资产进行评分，我们就可以得出一个综合评分，并根据评分对资产进行管理。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 从零构建软件产品或服务`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `从零开始构建软件产品或服务的完整流程与方法论。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
		...
		OriginalAuthor: `easychen`,
		Source: `一人企业方法论`,
		KnowledgeBody: `# 产品构建:从零构建软件产品或服务
...
准备好MVP后，我们就可以通过众筹来验证需求和最基本的营销能力了。当众筹达标，我们才进入下一步的迭代开发。反之，则回到价值主张部分重新优化或者转型。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 内容池与自动化能力`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `内容池与自动化能力：构建持续产出的内容体系。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
当然现在因为AI智能的问题，还只是一个辅助性的东西。但是我觉得这是暂时性的，因为AI的智能每个月都在提升，我觉得很快就可以达到普通人的标准。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 众包能力`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `众包能力：如何借助外部力量扩展一人企业的边界。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
如果你使用WordPress，它有一些现成的商业的威客插件。安装以后，可以为 WordPress 添加类似的任务发布、领取、验收、积分/现金结算的功能。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 一人企业的定义`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `什么是一人企业？以个体或个人品牌为主导的业务体定义与误区澄清。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
一人企业的竞争，有一半都是在认知上。因此，本书专门设置了「规划一人企业」这个模块，尝试从「底层逻辑」、「赛道选择」、「竞争策略」几个方面帮大家进行认知上的强化。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 副产品优势的发现`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `发现副产品优势：将工作中的副产品转化为商业价值。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
还有的人可能兴趣爱好很多，但都浅尝辄止，每隔一个月换一个。这种也难以产生优质副产品。如果没有能坚持数年持续投入的兴趣爱好，我们更建议考虑其他副产品。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 基建·用户池·触达能力`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `用户池与触达能力：构建私域流量与用户关系。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
通过微信的推送接口、群机器人（Wechaty）或者手机脚本方案（Auto.js），我们可以实现触达能力自动化。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 管理和利用不确定性`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `管理不确定性：在未知中找到机会并降低风险。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
此外，我们正在开发一款名为「方糖OPB」的WordPress插件，旨在为WordPress添加一些适用于个人企业的基础设施。通过安装这个插件并配置相应功能，可以轻松完成很多一人企业必须的基础功能，例如通过微信账号登录、微信支付以及使用WooCommerce进行众筹等。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 非竞争策略`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `一人企业的非竞争策略：避开巨头，找到差异化的生存空间。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
需要强调的是，一个产品是否属于新品类、是否和其他产品雷同，这完全取决于用户的认知，他们只会为自己的认知买单。这也直接影响着我们如何定位、宣传和推广产品，如何通过用户的使用体验塑造他们的认知。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 一人企业≠个体户`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `一人企业与个体户的本质区别，理解规模化与可复制性。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
「一人企业月报」的主要目的是让我们强制性地以全面的角度思考业务，并定期进行。确保我们不会漏掉重要的部分。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 一人企业画布与报告`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `一人企业画布工具：系统化梳理你的商业模式。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
		...
		OriginalAuthor: `easychen`,
		Source: `一人企业方法论`,
		KnowledgeBody: `# 思考工具:《一人企业画布》和《一人企业月报》
...
关于OPB月报的使用方法，请参考《一人企业VS一人业务》一节。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 方法论新版与作者介绍`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `方法论的迭代历程与作者 EasyChen 的创业故事。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
不谦虚地说，这是一人企业和副业创业领域少有的深度思考工具。实践过的人，都会感受到它的价值。希望它能成为你成功路上的强大助力。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 产品池与支付能力`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `产品池与支付能力：多产品矩阵与商业闭环。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
归根结底，众筹能力本质上是一种支付能力，它其实是一个商业模式的创新。如果我们的支付能力的组件化和自动化做得足够好的话，我们会发现像什么众筹啊，什么学完免费啊，这些看起来比较创新的商业模式都是很容易实现的。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 一人企业赛道选择`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `如何为一人企业选择赛道，避免红海竞争，找到适合的细分市场。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
注：由于政策限制，数字货币相关业务在中国大陆是被禁止的。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 搭建一人企业基建`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `实操：搭建一人企业基建的具体步骤与工具选择。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
自动验收面对的场景太复杂，很难有一个通用的插件可以处理，但可以通过积分系统+自行开发/生成插件来单独处理；如果接收人工验收，可以自行购买对应的成熟商业插件。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 滚雪球与链式传播`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `滚雪球效应与链式传播：低成本获客与增长策略。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
你看，只是简单调整项目完成的顺序，就可以获得更多收益，这就是规划的力量；也是我们花大篇幅来讲底层逻辑的原因。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 从副业开始`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `从副业起步的策略：如何在保持主业的同时启动一人企业。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
随着我们副业开始逐渐成长，我们就能逐步建立起抗风险的能力。我们通常建议，当副业的收入与主业收入相当时，也就是两者基本持平时，再考虑完全转型的事情。这样在各方面都能实现平滑过度。当然，是否转型完全取决于你自己的决定。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 结构化优势`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `如何构建结构化优势，让一人企业拥有可持续的竞争壁垒。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
当然，这种优势是否显著取决于所处的专属服务领域是否真正需要这种个性化特性。如果客户对此类服务的依赖性越强，那么这个优势就越明显。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 理想的一人企业基建`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `理想基建架构：用户池、产品池、内容池的完美组合。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
当然，最重要的一点是，我们希望这个基础设施可以很好地适配「一人企业方法论」、为我们这套可能是唯一的针对一人企业的方法论提供全程支撑，让使用这套方法论的用户可以开箱即用，不要再花更多时间在测试和开发基础功能上。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 为什么规模化是可能的`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `一人企业规模化的可能性：技术杠杆与自动化的力量。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
...
-   AI音频：Sébastien Night 创造了一款早期的 AI 产品 OneTake AI，并将其月回报率 (MRR) 从 $10k 增长到 $42k，年回报率 (ARR) 达到 $500k。他通过专注于转化真实录音而非生成内容，成功抓住 AI 技术的浪潮。Sébastien 强调了了解客户需求的重要性，通过直接与客户沟通，快速迭代产品以满足市场需求。他的成功策略包括明确的增长目标、有效的客户反馈机制和选择合适的技术栈，以及通过提供高价值产品来吸引和保留客户。`,
	},
	{
		...
		School:            `独立创业`,
		MajorLine:         `一人企业`,
		ArticleTitle:      `一人企业方法论 | 为什么做大是可能的`,
		LongBioPrefix:     opbLongBioPrefix,
		ShortBio:          `一人企业做大的可能性：超越收入天花板的思维方式。`,
		Audience:          opbAudience,
		WelcomeMessage:    `你好，欢迎问我关于一人企业、独立开发、副业和创业的问题。`,
		Education:         opbEducation,
		MajorLabel:        opbMajorLabel,
		...
		OriginalAuthor: `easychen`,
		Source: `一人企业方法论`,
		KnowledgeBody: `# 底层逻辑:为什么以小博大是可能的
