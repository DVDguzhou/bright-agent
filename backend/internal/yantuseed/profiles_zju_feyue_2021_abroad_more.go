...
var miaoYiPing = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 缪亦平 Math & Foundation of CS @ Oxford（境外升学）",
...
var zhangFa = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 张法 Math PhD@HKUST（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var dengXiYue = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 邓翕跃 MSc Statistical Science @ Oxford（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var geKaiJie = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 葛锴杰 Stat MA @ Columbia（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var maWanTeng = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 马万腾 Math PhD@HKUST（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var wuZhiHao = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 吴之昊 Stat PhD@CUHK（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
	ExpertiseTags: []string{"留学", "香港", "博士", "统计学", "浙江大学", "飞跃手册"},
	SampleQuestions: []string{
		"威斯康星 3+1+1 和保研冲突怎么选？",
...
var zhangZeXuan = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 张泽暄 Stat MS@UChicago（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var chenZe = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 陈泽 QCF@Gatech（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var tangZiFeng = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 唐梓峰 MScQF@ETH&UZH（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var tianZeRui = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 田泽睿 MFE@Columbia（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var xiZeCheng = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 奚泽成 MathFIN@NYU Courant（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var xuanNengKai = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 宣能恺 MSc FinTech@NTU（境外升学）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var daiYunXiang = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 戴昀祥 MFE@Columbia（院外受邀·金工）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var liaoHuaZe = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 廖华泽 MSMFT@BU（院外受邀·金工）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var liuHuBen = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 刘虎贲 MFin@MIT（院外受邀·金工）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
...
var qianXinYue = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 钱昕玥 MFin@MIT（院外受邀·金工）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
	ExpertiseTags: []string{"留学", "金融", "麻省理工", "浙江大学", "飞跃手册", "院外受邀"},
	SampleQuestions: []string{
		"Baruch 绿皮书没刷完面试会挂吗？",
...
var yeXuHua = Profile{
	...
	ArticleTitle:  "飞跃手册2021 | 叶煦华 MSCF@CMU（院外受邀·金工）",
	LongBioPrefix: zjuFeyue2021LongBioPrefix,
