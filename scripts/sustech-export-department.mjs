 ...
 *   node scripts/sustech-export-department.mjs --dept bio --out "C:/Users/Caiqing/Desktop/post"
 *
 *   # 全站「研究生项目总结」侧栏院系：凡 metadata.department 非空的 /post/ 条目（约百余篇）
 *   node scripts/sustech-export-department.mjs --all --out "C:/Users/Caiqing/Desktop/post"
 *
