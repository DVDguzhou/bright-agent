...
--
-- 在服务器执行示例（密码按实际修改）：
--   mysql -h127.0.0.1 -uroot -p agent_marketplace < scripts/assets/assign-life-agent-cover-presets.sql
-- Docker 内示例：
--   docker compose exec -T mysql mysql -uroot -p"${MYSQL_ROOT_PASSWORD}" agent_marketplace < scripts/assets/assign-life-agent-cover-presets.sql
