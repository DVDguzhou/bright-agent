 ...
 *
 * 使用：node scripts/life-agent/test-voice.mjs
 * 环境变量：
 ...
 * PowerShell：$env:TEST_BASE_URL="http://host:3000"; node scripts/life-agent/test-voice.mjs
 * cmd.exe：set TEST_BASE_URL=http://host:3000&& node scripts/life-agent/test-voice.mjs
 *
