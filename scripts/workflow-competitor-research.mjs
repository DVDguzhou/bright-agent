 ...
 *
 * 用法: node scripts/workflow-competitor-research.mjs [url1] [url2] ...
 * 示例: node scripts/workflow-competitor-research.mjs https://example.com https://github.com
 */
...
用法（竞品调研工作流 - Agent 协作）:
  ...
  node scripts/workflow-competitor-research.mjs <url1> <url2> ...

示例:
  node scripts/workflow-competitor-research.mjs https://example.com https://github.com https://www.baidu.com
`);
    return;
  }

  if (urls.length === 0) {
    console.log("请提供至少一个 URL，例如: node scripts/workflow-competitor-research.mjs https://example.com");
    return;
  }
