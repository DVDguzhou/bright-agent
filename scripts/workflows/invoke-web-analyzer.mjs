 ...
 * 用法: node scripts/workflows/invoke-web-analyzer.mjs [url]
 */
...
用法:
  ...
  node scripts/workflows/invoke-web-analyzer.mjs [url]

示例:
  node scripts/workflows/invoke-web-analyzer.mjs https://www.baidu.com
  node scripts/workflows/invoke-web-analyzer.mjs https://github.com
`);
    return;
  }
